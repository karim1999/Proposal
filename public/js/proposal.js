...
var TEXT_DEFAULT = '<h2 style="margin-left:0px;">What is Lorem Ipsum?</h2><p style="margin-left:0px;"><strong>Lorem Ipsum</strong><span style="background-color:rgb(255,255,255);color:rgb(0,0,0);"> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy</span></p>';
var store = new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  ...
  mutations: {
    addSection: function addSection(state, index) {
    ...
    setSectionType: function setSectionType(state, payload) {
      console.log(payload.index);
      Vue.set(state.sections, payload.index, _objectSpread(_objectSpread({}, state.sections[payload.index]), {}, {
        type: payload.type
      }));
    },
    deleteSection: function deleteSection(state, index) {
      if (state.sections.length != 1) {
        console.log("Removing the section with index ", index);
        state.sections.splice(index, 1);
      }
    },
    updateSection: function updateSection(state, payload) {
      Vue.set(state.sections, payload.index, _objectSpread(_objectSpread({}, state.sections[payload.index]), payload));
    },
    sortSections: function sortSections(state, value) {
...
/***/ 1:
/*!****************************************!*\
  !*** multi ./resources/js/proposal.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\projects\web\Proposal\resources\js\proposal.js */"./resources/js/proposal.js");
